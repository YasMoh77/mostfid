...
session_start();
$title='مستفيد | شراء خدمات بخصومات';       //title of the page
$keywords='<meta name="keywords" content="    منصة  ,  شراء  ,  تعليمية ,  خدمات ,  دورات , مستفيد , ترفيه , صيانة ,  نقل , ترجمة  , افراد , بضائع , خصم  , كوافير  , خصومات      ">';
$description='<meta name="description" content="منصة مستفيد لشراء الخدمات بخصومات؛ ترجمة نقل أفراد و بضائع دورات تعليمية خدمات ترفيهية كوافير صيانة وغيرها؛ جميع الخدمات عليها خصومات حقيقية؛ شعار مستفيد انت اولى بالخصم    ">';
...
?>
  ...
  <section class="para-section para-s ">
   <div class="son" >
	 <div class="div-ul">
		<div class="div-first">أقسام الخدمات</div>   
		<ul>
			<?php
		    ...
		    if (!empty($cats)) {
		    	foreach ($cats as $cat) { ?>
		    		<li><i class="fas fa-star"></i><a href="search-v.php?k=<?php echo $cat['cat_id']?>"><?php echo $cat['cat_nameAR'];?></a></li>
		    <?php }
		    } ?>
		</ul>
	</div>
	<div class="div-img">
		<img src="layout/images/shop2.png" alt="عروض وخصومات مستفيد "> 
	</div>
</div>
</section>
...
<div class="icons"> 
	...
	<div class="con"><a href="search-v.php?k=12"><i class="fas fa-truck"></i></a> <p>خدمات نقل </p></div>
	<div class="con"><a href="search-v.php?k=13"><i class="fas fa-screwdriver"></i></a> <p>خدمات صيانة </p></div>
	<div class="con"><a href="search-v.php?k=14"><i class="fas fa-building building-service"></i></a> <p>خدمات المنزل والمعمار </p></div>
	<div class="con"><a href="search-v.php?k=15"><i class="fas fa-user-graduate"></i></a> <p>تعليم وتدريب  </p></div>
	<div class="con"><a href="search-v.php?k=16"><i class="fas fa-dove"></i></a> <p>مظهر وتجميل  </p></div>
	<div class="con"><a href="search-v.php?k=17"><i class="fas fa-video"></i></a> <p>خدمات ترفيهية  </p></div>
</div>
...
<div class="index-below">
					   ...
					   <span class="alone cut2"><span class="small" title="<?php echo $value['cat_nameAR']?>"><?php echo $value['cat_nameAR'].'</span> > <span class="small" title="'.$value['subcat_nameAR'].'">'.$value['subcat_nameAR'];?></span></span>
	 					...
	 					<div class="finalPrice-div ">
		 					...
		 					if (isset($_SESSION['traderid'])&&$_SESSION['traderid']!=$value['user_id'] ) { //appears as a link for users
		 					 	?> <a class="a-phone" title="تقديم طلب شراء " href="order.php?id=<?php echo $value['item_id']?>&t=i&main=v"><i class="fas fa-phone"></i></a> <?php
		 					}elseif (isset($_SESSION['userEid'])||isset($_SESSION['userGid'])||isset($_SESSION['userFid'])) {
		 						?> <a class="a-phone" title="اطلب شراء المنتج " href="order.php?id=<?php echo $value['item_id']?>&t=i&main=v"><i class="fas fa-phone"></i></a> <?php
		 					}elseif (isset($_SESSION['traderid'])&&$_SESSION['traderid']==$value['user_id']) {
		...
		<?php	}
		 ?></div> 
		<a class="see-more" href="search-v.php?cat=0&state=0&ordering=1">شاهد المزيد </a>
	</div>
  <?php } ?>
		...
		if (!empty($itemsGET)) { ?>
		<div class="inner">
		  <span>الخدمات الأحدث اضافة </span>
		  <div class="items-container items-container-profile"> <?php
			foreach ($itemsGET as $value) { 
				$ratio=$value['price']*($value['discount']/100);
                $finalPrice=number_format(round($value['price']-$ratio) ) ;
		...
		<?php	}
		 ?></div> 
		<a class="see-more"  href="search-v.php?cat=0&state=0&ordering=2">شاهد المزيد </a> 
	</div>
<?php } ?>
		...
		if (!empty($itemsGET3)) { ?> 
		<div class="inner">
		  <span>الخدمات  الأكثر  مشاهدة </span> 
		  <div class="items-container items-container-profile"> <?php
		...
		<?php	}
		 ?></div> 
		<a class="see-more" href="search-v.php?cat=0&state=0&ordering=3">شاهد المزيد </a>
	</div>
	<?php } ?>
</div>
