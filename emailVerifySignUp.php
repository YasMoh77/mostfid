...
//$_SESSION['codeSignUpMos'][0][1]==EMAIL,CODE  => from formSignUpUs.php
...
//////
  if(isset($_SESSION['codeSignUpMos']) ){ //verification comes from signUp.php & from login.php if didn't verify his email as there's a session set on formSignUp.php and not destroyed yet.
   $email=$_SESSION['codeSignUpMos'][0];
   $code=$_SESSION['codeSignUpMos'][1]; 
 }else{
...
$mail->Subject=$lang['welcome2Mostafed'];
$mail->isHTML(true);
$mail->Body='
<h1 style="text-align:right;">'.$lang['welcome2Mostafed'].'</h1>
  ...
  <div style="text-align:right;list-style-type:circle">
    ...
    <h3 style="margin-bottom:-1vh">'.$lang['goTo'].' '.'<a href="https://www.mostfid.com/emailVerifySign.php">'.' '.$lang['verifyPage'].'</a></h3> 
...
$mail->Body= '
 <div>
  ...
  <div style="">
    ...
    <h4 style="margin-bottom:-1vh">'.$lang['goTo'].' '.'<a href="https://www.mostfid.com/emailVerifySign.php">'.' '.$lang['verifyPage'].'</a></h4> 
...
//SUCCESS
if($mail->Send() ) { 
 ?> <script> window.location.href='emailVerifySign.php';  </script> <?php 
